    ...
    return (
        <div className="App">
            ...
            className='border-2  border-black-600 w-56 rounded mt-8 '
                ...
                value={day=== null ? '' : `${day} ${'/'} ${month+1} ${'/'} ${year}`}
            />
                ...
                <div className=''>
                    ...
                    <Calendar year={year} month={month} day={day} setDay={setDay} setMonth={setMonth} setYear={setYear}/>
                    <div className='flex justify-between'>
                        <button onClick={buttonHandler2} >prev</button>
                    ...
                    <Calendar year={year} month={month + 1} day={day} setDay={setDay } setMonth={setMonth} setYear={setYear}/>
                </div>
            </Modal>
        </div>
    );
